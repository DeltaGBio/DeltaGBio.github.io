...
{% include section.html background="images/background_blue.jpg" %}
...
{% include figure.html image="images/icon.jpg" %}
{% include figure.html image="images/icon.jpg" caption="_Lorem_ **ipsum**." %}
{% include figure.html image="images/icon.jpg" caption="_Lorem_ **ipsum**. `px` width" width="400px" %}
{% include figure.html image="images/icon.jpg" caption="_Lorem_ **ipsum**. `%` width" link="team" width="50%" %}
{% include figure.html image="images/icon.jpg" caption="_Lorem_ **ipsum**. `px` height" link="team" height="200px" %}
...
{% endcapture%}
{% include feature.html image="images/icon.jpg" link="team" title="Title" text=text %}
{% include feature.html image="images/icon.jpg" title="Title" text=text flip=true %}
...
{% include card.html image="images/icon.jpg" link="https://nasa.gov/" title="A Large Card" subtitle="A cool card" description="A cool description" tooltip="A cool tooltip" tags="manual tag" repo="greenelab/lab-website-template" %}
{% include card.html image="images/icon.jpg" title="A Small Card" subtitle="A cool card" description="_Lorem_ **ipsum**" tooltip="A cool tooltip" tags="manual tag" repo="greenelab/lab-website-template" style="small" %}
...
{% capture content %}
{% include figure.html image="images/icon.jpg" caption="Caption" width="200px" %}
{% endcapture %}
...
![image]({{ "/images/icon.jpg" | relative_url }})
...
{% capture col1 %}
{% include figure.html image="images/icon.jpg" caption="Fig. 1a" %}
Lorem _ipsum_ dolor **sit** amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
{% endcapture %}
{% capture col2 %}
{% include figure.html image="images/icon.jpg" caption="Fig. 1b" %}
Lorem _ipsum_ dolor **sit** amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
{% endcapture %}
{% capture col3 %}
{% include figure.html image="images/icon.jpg" caption="Fig. 1c" %}
Lorem _ipsum_ dolor **sit** amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
{% endcapture %}
{% include cols.html col1=col1 col2=col2 col3=col3 %}
